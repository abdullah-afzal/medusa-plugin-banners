...
import { Container, Heading, toast, Button, Text, IconButton } from "@medusajs/ui";
import { useAdminCollection, useMedusa, useAdminUpdateCollection } from "medusa-react";
...
const EditCategoryBanner = () => {
    ...
    const updateCategory = useAdminUpdateCollection(id)
    ...
    useEffect(() => {
        if(collection)
        setSelectedImg(collection?.banner)
        ...
        <>
            ...
            <Container style={{ margin: "5px" }}>
                <div className="flex items-center">
                    <Heading level="h1">Edit {collection?.title} Collection's Banner</Heading>
                </div>
